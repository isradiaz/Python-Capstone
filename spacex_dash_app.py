...
def get_scatter(launch_site):
    filtered_scat = spacex_df['Launch Site'] == launch_site
    if launch_site == 'ALL':
        fig2 = px.scatter(spacex_df, x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig2
    
    else: 
        fig3 = px.scatter(filtered_scat, x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig3
